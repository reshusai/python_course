...
def test_list_slice_replacement_is_inplace():
    ...
    fruits[3:] = ["apple"]
    assert ['banana', 'litchi', 'guava', 'apple'] == fruits
...
def test_list_common_methods():
    ...
    assert ["mango", "apple", "orange"] == fruits

    fruits.insert(0, "banana")
    assert ['banana', 'mango', 'apple', 'orange'] == fruits

    fruits.extend(["litchi", "guava"])
    assert ['banana', 'mango', 'apple', 'orange', 'litchi', 'guava'] == fruits

    fruits.reverse()
    assert ['guava', 'litchi', 'orange', 'apple', 'mango', 'banana'] == fruits

    fruits.pop()
    assert ['guava', 'litchi', 'orange', 'apple', 'mango'] == fruits

    fruits.pop(0)
    assert ['litchi', 'orange', 'apple', 'mango'] == fruits
